...
function Account() {
  ...
  function getUsers() {
    axios.get('http://localhost/restaurantcv/backend/user/').then(function (response) {
  ...
  const deleteUser = (id) => {
    axios.delete(`http://localhost/restaurantcv/backend/user/${id}/delete`).then(function (response) {
      console.log(response.data);
      getUsers();
    });
  }
